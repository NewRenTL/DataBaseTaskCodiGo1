...
insert into category (category_name, description) values ('Asterix and the Big Fight (Astérix et le coup du menhir)', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus.');
